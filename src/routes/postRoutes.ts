 ...
 *     description: Retrieve all posts with pagination (requires authentication)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *     description: Retrieve a single post by its ID (requires authentication)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     description: Delete an existing post (only the owner can delete)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
